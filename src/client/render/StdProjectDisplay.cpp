...
StdProjectDisplay::StdProjectDisplay() {
    ...
    posFrameImage.x=0;
    posFrameImage.y=0;
    this->frameImage = make_shared<Image>(Image("../src/client/img/std_project_background",posFrameImage));
    ...
    this->discardButton=make_shared<Button>(Button("../src/client/img/std_project_discard", clickAreaDiscardButton,posDiscardButton));
    ...
    this->prodEnergyButton=make_shared<Button>(Button("../src/client/img/std_project_prod_energy", clickAreaProdEnergyButton,posProdEnergyButton));
    ...
    this->temperatureButton=make_shared<Button>(Button("../src/client/img/std_project_temperature", clickAreaTemperatureButton,posTemperatureButton));
    ...
    this->forestButton= make_shared<Button>(Button("../src/client/img/std_project_forest", clickAreaForestButton,posForestButton));
    ...
    this->cityButton=make_shared<Button>(Button("../src/client/img/std_project_city", clickAreaCityButton,posCityButton));
